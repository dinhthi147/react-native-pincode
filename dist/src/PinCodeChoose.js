    ...
    constructor(props) {
        ...
        this.endProcessConfirm = async (pinCode) => {
            if (pinCode === this.state.pinCode) {
                ...
                this.setState({ status: PinCode_1.PinStatus.confirm });
            }
        };
        this.cancelConfirm = () => {
